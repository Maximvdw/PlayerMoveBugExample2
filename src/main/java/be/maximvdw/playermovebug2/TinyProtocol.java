...
import be.maximvdw.playermovebug2.Reflection.*;
...
public abstract class TinyProtocol {
	...
	public TinyProtocol(final Plugin plugin) {
		...
		try {
			...
			// Damn you, late bind
			plugin.getLogger().info("[TinyProtocol] Delaying remote channel injection due to late bind.");
	...
	private void registerChannelHandler() {
		...
		for (int i = 0; looking; i++) {
			...
			for (Object item : list) {
				...
				// Channel future that contains the remote connection
	...
	/**
	 * Invoked when the remote is starting to send a packet to a player.
	 * <p>
	...
	/**
	 * Invoked when the remote has received a packet from a given player.
	 * <p>
	 ...
	 * @param packet - the packet that will be received by the remote.
	 */
